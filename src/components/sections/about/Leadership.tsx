  ...
  const leadershipItems = [
    {
      ...
      description:
        "Spearhead the organization of social activities for 800+ club members, overseeing event planning, logistics and communication to create engaging and enjoyable experiences for all participants.",
    },
    {
      id: "lead-2",
      ...
      description:
        "Immersed in the KWORKS ecosystem, gaining hands-on experience in startup acceleration programs, collaborating directly with KWORKS experts.",
    },
    {
      id: "lead-3",
      ...
      description:
        "Participated in a program designed to support entrepreneurs in transforming innovative ideas into viable business models and becoming integral parts of the entrepreneurship ecosystem.",
    },
    {
      id: "lead-4",
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        <div className="space-y-8">
          {leadershipItems.map((item) => (
            <div
              key={item.id}
              className="border-l-4 border-[#7D9D9C] pl-4 py-1"
            >
