    ...
    <section className="mb-12">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        <p className="text-gray-700 mb-4">
          I am passionate about building innovative software solutions that solve real-world problems. With a strong foundation in both Computer Engineering and Economics, I aim to bridge the gap between technical expertise and business understanding.
        </p>
        <p className="text-gray-700 mb-4">
