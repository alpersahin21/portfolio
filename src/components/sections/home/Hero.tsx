      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-gray-700 text-lg mb-4">
            I&apos;m a Computer Engineering graduate and Economics DM student at
            Koç University, passionate about software development and
            entrepreneurship. I focus on solving real-world problems through
            technology, employing creative and analytical approaches to craft
            effective solutions.
          </p>
          <p className="text-gray-700 text-lg mb-8">
            Currently, I&apos;m working as a Fullstack Developer at{" "}
            <a
              href="https://codeway.co/"
              target="_blank"
        ...
        <div className="flex justify-center md:justify-end">
          <div
            className="profile-image-container w-64 h-64 md:w-80 md:h-80"
